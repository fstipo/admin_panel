...
const Sidebar = () => {
  return (
    <div
      className="sidebar d-flex flex-shrink-0 flex-column p-3 text-white bg-dark"
      // style="width: 280px"
    >
      <a
        href="/"
        className="d-flex align-items-left mb-md-0 me-md-auto text-white text-decoration-none"
      >
        <svg
